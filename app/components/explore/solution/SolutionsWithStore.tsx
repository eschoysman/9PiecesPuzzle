...
import {puzzleSolutionSelector} from "@/app/features/puzzle/puzzleSolutionSlice";
...
export default function SolutionsWithStore({showSolutions,cellSize,colorToShow,filter}: SolutionsProps) {
    ...
    // const solutionState = useAppSelector(puzzleSolutionSelector);
    // const solution = solutionState.value;
    ...
    const listSolutions = solution!.type!=="UNMAKEABLE" ? solution!.combinations
        .map((combination,index) => {
            ...
            if(solutionFilter(combination.combination) && (!subKey || index === subKey-1)) {
